...
//            console.log("biaozhi")
    ...
    $.fn.step = function(options) {
        ...
        this.find(".step-beizhu").eq(opts.initStep-1).show();
//            this.find(".step-bar").css({ "width":"100%",
//            "background": 'url(../../../public/assets/img/bar-bg.png)' ,
//            "position":"relative",
//            "border-radius": 12+"px",
//            "z-index": -1,
//            "height": 5+"px",
//            "top": 70+"px"});
        ...
        this.goStep=function(page) {
            ...
            this.find(".step-beizhu").hide();

            this.find(".step-list").eq(curPage-1).show();
            this.find(".step-beizhu").eq(curPage-1).show();
            this.find(".step-header li").each(function (i, li) {
                $li=$(li);
